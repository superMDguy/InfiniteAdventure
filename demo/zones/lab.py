"""Secret Lab. 
Created to test out how Tale works"""
...
lab= Location("Secret Lab", "A dim room, with long tables and flickering computer screens.  A chemical smell fills the air.")
Cupboard = Location("Closet", "A small room.")
